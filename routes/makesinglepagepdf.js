...
//                    fs.writeFile(config.fileLocation + "/" + fileName + '.png', base64Image, {encoding: 'base64'}, function(err) {
                ...
                */
//                        var commandline = config.converterLocation + config.ax2024_executable+" "+"-i=\""+config.fileLocation+fileName+".png\" -o=\""+config.fileLocation+fileName+".pdf\" -f=pdf -"+pageformat+" -"+rotation;
                        var commandline = config.converterLocation + config.ax2024_executable+" "+"-i=\""+config.fileLocation+tempFileName+".png\" -o=\""+config.fileLocation+tempFileName+".pdf\" -f=pdf -"+pageformat+" -"+rotation;
