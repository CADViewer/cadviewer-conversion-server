...
var express = require('express'),
    ...
    function AX2022_callback(res, outputFormat, contentLocation, callbackMethod, tempFileName){
        ...
        try{	
            ...
            if (config.cvjs_debug) console.log("AX2022_callback  - global counter: "+globalCounter+" outputFormat:"+outputFormat);
            
            if (outputFormat.toLowerCase().indexOf("svg")>-1){   // svg + svgz
        
                var exitCode = 0;
                CVJSresponse = "{\"completedAction\":\"svg_creation\",\"errorCode\":\"E"+exitCode+"\",\"converter\":\"AutoXchange AX2022\",\"version\":\"V2.00\",\"userLabel\":\"fromCADViewerJS\",\"contentLocation\":\""+contentLocation+"\",\"contentResponse\":\"stream\",\"contentStreamData\":\""+callbackMethod+"?remainOnServer=0&fileTag="+tempFileName+"&Type="+outputFormat+"\"}";
    ...
    function cvjs_processLinkList(cvjsRequestJSON, res){
        ...
        try{
            ...
            for (var i = 0; i < cvjsRequestJSON.parameters.length; i++) {
                ...
                // get rid of fpath when calling from CV
                ...
                .on('finish', () => {
                    ...
                    if ( fileFormat == ".svg"){
                        ...
                        exec(commandline, (err, stdout, stderr) => {
                          ...
                          AX2022_callback(res, outputFormat, contentLocation, config.ServerUrl+"/"+config.callbackMethod, tempFileName);	  
