...
var customendpointextension = require('./cvjs_customConversionEndpointExtension_cv6.9.12.js');
...
var express = require('express'),
    ...
    function AX2022_callback(res, stderr, exitCode, outputFormat, contentLocation, callbackMethod, tempFileName){
        ...
        try{	
            ...
            if (config.cvjs_debug) console.log("AX2022_callback outputFormat:"+outputFormat+" exitcode:"+exitCode+"XX");
...
//                    var exitCode = 0;
    ...
    function LinkList2022_callback(res, outputFormat, contentLocation, callbackMethod, tempFileName){
        try{	
            ...
            var exitCode = 0;
            CVJSresponse = "{\"completedAction\":\"data_extraction\",\"errorCode\":\"E"+exitCode+"\",\"converter\":\"LinkList2022\",\"version\":\"V2.00\",\"userLabel\":\"fromCADViewerJS\",\"tempFile\":\""+tempFileName+"."+outputFormat+"\",\"contentLocation\":\""+contentLocation+"\",\"contentResponse\":\"stream\",\"contentStreamData\":\""+callbackMethod+"?remainOnServer="+remainOnServer+"&fileTag="+tempFileName+"&Type="+outputFormat+"\"}";
            ...
            res.send("LinkList2022_callback:"+e);	
    ...
    function cvjs_processConversion_pdf_svg_cadviewerdisplay(cvjsRequestJSON, res, action){
        ...
        */
        ...
        if (customConversionEndpointExtension){
            ...
            console.log("!!!!!!!!!!!!!!!!!!!customConversionEndpointExtension")
