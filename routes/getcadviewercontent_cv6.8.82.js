...
router.get('/getcadviewercontent', function (req, res) {
        ...
        try {
            ...
            if (config.cvjs_debug) console.log('/loadfile: '+inputFile+" Remain on Server:  "+remainOnServer+" fileType="+Type+ " returnCadviewer="+returnCadviewer);
                ...
                if (Type.indexOf("svgz")>-1 && config.cvjs_svgz_compress){   
                    ...
                    fs.readFile( inputFile, function(err, data) {
                        if (err){
                            ...
                            //if (config.cvjs_debug) console.log("svgz: returnfile" + data);	
