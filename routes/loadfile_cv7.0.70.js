...
function loadFile(req,res){
	...
	try {
		...
		if (config.cvjs_debug) console.log('1: /loadfile: '+inputFile+"   ");
		...
		if (inputFile.indexOf(config.ServerFrontEndUrl)==0){
            ...
            if (inputFile.indexOf(config.ServerUrl)==0){
                ...
                if ((loadtype!= undefined && loadtype.indexOf("menufile")==0) || (loadtype!= undefined && loadtype.indexOf("languagefile")==0)){
