...
//		if (config.cvjs_debug) console.log("get-post /loadfile");
		...
		if ( (config.ServerFrontEndUrl!="") && (inputFile.indexOf(config.ServerFrontEndUrl)==0) && (inputFile.indexOf(config.ServerUrl)!=0)){
            
            if (config.cvjs_debug) console.log("branch 1");
            ...
            if (inputFile.indexOf(config.ServerUrl)==0){
                if (config.cvjs_debug) console.log("branch 2");
                ...
                if ((loadtype!= undefined && loadtype.indexOf("menufile")==0) || (loadtype!= undefined && loadtype.indexOf("languagefile")==0) || (loadtype!= undefined && loadtype.indexOf("merge")==0) || (loadtype!= undefined && loadtype.indexOf("redline")==0)){
                    ...
                    if (inputFile.indexOf("http:")==0 || inputFile.indexOf("https:")==0){
                        ...
                        if (config.cvjs_debug) console.log("branch 3");
                    }
                    else 

                        if (inputFile.indexOf(config.ServerLocation) == 0){
                            // do nothing if serverlocation is in front of filename
                            if (config.cvjs_debug) console.log("branch 4");

                        }
                        else{
                            if (config.cvjs_debug) console.log("branch 5");
