...
var customendpointextension = require('./cvjs_customConversionEndpointExtension_cv7.0.26.js');
...
var express = require('express'),
        ...
        try{	
            ...
            if (outputFormat.toLowerCase().indexOf("svg")>-1){   // svg + svgz
                ...
                if (outputFormat.toLowerCase().indexOf("pdf")>-1){
                    ...
                    CVJSresponse = "{\"completedAction\":\"pdf_creation\",\"errorCode\":\"E"+exitCode+"\",\"converter\":\"AutoXchange AX2022\",\"version\":\"V2.00\",\"userLabel\":\"fromCADViewerJS\",\"tempFile\":\""+tempFileName+"."+outputFormat+"\",\"contentLocation\":\""+contentLocation+"\",\"contentResponse\":\"file\",\"contentStreamData\":\""+contentStream+"\"}";
    ...
    function LinkList2023_callback(res, outputFormat, contentLocation, callbackMethod, tempFileName, splityflag){
        try{	
            ...
            CVJSresponse = "{\"completedAction\":\"data_extraction\",\"errorCode\":\"E"+exitCode+"\",\"converter\":\"LinkList2023\",\"version\":\"V2.00\",\"userLabel\":\"fromCADViewerJS\",\"tempFile\":\""+tempFileName+"."+outputFormat+"\",\"contentLocation\":\""+contentLocation+"\",\"contentResponse\":\"stream\",\"contentStreamData\":\""+callbackMethod+"?remainOnServer="+remainOnServer+"&fileTag="+tempFileName+"&Type="+outputFormat+"\"}";
            ...
            if (!splityflag){  // standard execution
                ...
                //$splitterFile = true;
                // remainOnServer = true
                CVJSresponse = "{\"completedAction\":\"data_extraction\",\"errorCode\":\"E"+exitCode+"\",\"converter\":\"LinkList2023\",\"version\":\"V2.00\",\"userLabel\":\"fromCADViewerJS\",\"tempFile\":\""+tempFileName+"."+outputFormat+"\",\"contentLocation\":\""+contentLocation+"\",\"contentResponse\":\"stream\",\"contentStreamData\":\""+callbackMethod+"?remainOnServer="+1+"&splitterFile="+true+"}";
            }
            */
    ...
    function cvjs_returnIfSVGhttp(contentLocation, tempFileName){
            ...
            if (contentLocation.indexOf("http:")==-1  && contentLocation.indexOf("https:")==-1){
                ...
                if (fileFormatFlag>-1){   // we have svg
                    ...
                    var CVJSresponse = "{\"completedAction\":\"svg_creation\",\"errorCode\":\"E"+0+"\",\"converter\":\"AutoXchange AX2020\",\"version\":\"V1.00\",\"userLabel\":\"fromCADViewerJS\",\"tempFile\":\""+tempFileName+"."+outputFormat+"\",\"contentLocation\":\""+contentLocation+"\",\"contentResponse\":\"stream\",\"contentStreamData\":\""+config.ServerUrl+"/"+config.callbackMethod+"?remainOnServer=1&fileTag="+tempFileName+"&Type=svg\"}";
