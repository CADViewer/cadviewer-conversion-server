...
const get_is_python_installed_1 = require("./utils/get-is-python-installed");
...
// To implement
exports.IS_BUILD_TOOLS_INSTALLED = false;
exports.OFFLINE_PATH = process.env.npm_config_offline_installers;
exports.IS_DRY_RUN = !!process.env.npm_config_dry_run_only;
exports.INSTALLED_PYTHON_VERSION = get_is_python_installed_1.getIsPythonInstalled();
exports.IS_PYTHON_INSTALLED = !!exports.INSTALLED_PYTHON_VERSION;
exports.PYTHON = process.arch === 'x64'
    ? {
...
exports.BUILD_TOOLS = getBuildTools();
...
exports.installerScriptPath = exports.IS_DRY_RUN
